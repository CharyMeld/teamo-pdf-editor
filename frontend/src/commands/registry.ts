...
export const REGISTRY: Command[] = [
  ...
  },
  {
    id: "home.save",
    label: "Save",
    description: "Save changes to the current document",
    tab: "HOME",
    group: "Document",
  ...
  },
  {
    id: "home.saveAs",
    label: "Save a Copy",
    description: "Save the current document as a new file",
    tab: "HOME",
    group: "Document",
  ...
  // ---- ORGANIZE --------------------------------------------------------------
  {
    id: "organize.rotate",
    label: "Rotate",
    description: "Rotate the selected page",
    tab: "ORGANIZE",
    group: "Pages",
    ...
    dropdown: [
      {
        ...
        label: "Rotate Left",
        description: "Rotate the selected page 90° counter-clockwise",
        tab: "ORGANIZE",
        group: "Pages",
        keywords: ["rotate ccw"],
        status: UNIMPLEMENTED,
      },
      {
        ...
        label: "Rotate Right",
        description: "Rotate the selected page 90° clockwise",
        tab: "ORGANIZE",
        group: "Pages",
        keywords: ["rotate cw"],
        status: UNIMPLEMENTED,
  ...
  },
  {
    ...
    label: "Delete Page",
    description: "Remove the selected page from the document",
    tab: "ORGANIZE",
    group: "Pages",
...
export const CONTEXTUAL_COMMANDS: Record<Exclude<SelectionType, "none">, Command[]> = {
  page: [
    ...
    },
    {
      ...
      label: "Delete Page",
      description: "Remove the selected page",
      tab: "ORGANIZE",
      group: "Selected Page",
      keywords: ["delete"],
      status: UNIMPLEMENTED,
    },
    {
      ...
      label: "Extract Page",
      description: "Save the selected page as a new document",
      tab: "ORGANIZE",
      group: "Selected Page",
      keywords: ["extract"],
      status: UNIMPLEMENTED,
